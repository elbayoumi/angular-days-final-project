...
ngOnInit() {
  this.cart_product_id = (this.activatedRoute.snapshot.params['id']);
  this.cart_product = this.products.find(p => p.id == this.cart_product_id);
  this.cart_products.push(this.cart_product);
}
}
